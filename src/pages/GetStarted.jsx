            ...
            <div
              ...
              className={`border-2 border-dashed rounded-lg sm:rounded-xl p-3 sm:p-4 text-center cursor-pointer transition-all duration-300 ${
                photoPreview
                  ...
                  : 'border-red-300 hover:border-blue-400 hover:bg-blue-50/70 hover:shadow-md'
              }`}
            >
              <input
                type="file"
              ...
              {photoPreview ? (
                ...
                <div className="py-4 sm:py-6 px-2 sm:px-4">
                  ...
                  <p className="text-xs sm:text-sm text-gray-700 font-medium">Drag and drop a photo here <span className="text-red-500 font-bold">*</span></p>
                  ...
                  <p className="text-[10px] sm:text-xs text-red-500 mt-1 font-medium">Photo is required</p>
                </div>
              )}
            </div>
          </div>
